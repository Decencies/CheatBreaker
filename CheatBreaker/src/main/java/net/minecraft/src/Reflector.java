...
public class Reflector
{
    ...
    public static ReflectorClass MinecraftForgeClient = new ReflectorClass("net.minecraftforge.com.cheatbreaker.client.MinecraftForgeClient");
    ...
    public static ReflectorClass ForgeHooksClient = new ReflectorClass("net.minecraftforge.com.cheatbreaker.client.ForgeHooksClient");
    ...
    public static ReflectorClass FMLClientHandler = new ReflectorClass("cpw.mods.fml.com.cheatbreaker.client.FMLClientHandler");
    ...
    public static ReflectorClass ItemRenderType = new ReflectorClass("net.minecraftforge.com.cheatbreaker.client.IItemRenderer$ItemRenderType");
    ...
    public static ReflectorClass IRenderHandler = new ReflectorClass("net.minecraftforge.com.cheatbreaker.client.IRenderHandler");
    ...
    public static ReflectorClass DrawScreenEvent_Pre = new ReflectorClass("net.minecraftforge.com.cheatbreaker.client.event.GuiScreenEvent$DrawScreenEvent$Pre");
    ...
    public static ReflectorClass DrawScreenEvent_Post = new ReflectorClass("net.minecraftforge.com.cheatbreaker.client.event.GuiScreenEvent$DrawScreenEvent$Post");
    ...
    public static ReflectorClass EntityViewRenderEvent_FogColors = new ReflectorClass("net.minecraftforge.com.cheatbreaker.client.event.EntityViewRenderEvent$FogColors");
    ...
    public static ReflectorClass EntityViewRenderEvent_FogDensity = new ReflectorClass("net.minecraftforge.com.cheatbreaker.client.event.EntityViewRenderEvent$FogDensity");
    ...
    public static ReflectorClass EntityViewRenderEvent_RenderFogEvent = new ReflectorClass("net.minecraftforge.com.cheatbreaker.client.event.EntityViewRenderEvent$RenderFogEvent");
    ...
    public static ReflectorClass SplashScreen = new ReflectorClass("cpw.mods.fml.com.cheatbreaker.client.SplashProgress");
