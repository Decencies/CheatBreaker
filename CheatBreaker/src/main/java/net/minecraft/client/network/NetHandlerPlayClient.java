...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleEntityMovement(S14PacketEntity p_147259_1_) {
        ...
        if (var2 != null) {
            ...
            double var7 = (double) var2.serverPosZ / 32.0D;
            CheatBreaker.getInstance().getVoiceChatManager().handlePosition(var2.getUniqueID(), var3, var5, var7);
    ...
    public void handleCustomPayload(S3FPacketCustomPayload p_147240_1_) {
        CheatBreaker.getInstance().getEventBus().callEvent(new PluginMessageEvent(p_147240_1_.func_149169_c(), p_147240_1_.func_149168_d()));
