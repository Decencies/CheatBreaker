...
public class WorldClient extends World
{
    ...
    /**
     * The hash set of entities handled by this com.cheatbreaker.client. Uses the entity's ID as the hash set's key.
     */
    private IntHashMap entityHashSet = new IntHashMap();

    /** Contains all entities for this com.cheatbreaker.client, both spawned and non-spawned. */
    private Set entityList = new HashSet();

    /**
     * Contains all entities for this com.cheatbreaker.client that were not spawned due to a non-present chunk. The game will attempt to
     ...
     * com.cheatbreaker.client-side in the intervening 80 receive ticks.
     */
