...
public final class HudUtil {
    private static final int[] colorCodes = new int[]{0,
            170,
            43520,
            43690,
            11141120,
    ...
    /**
     * Draws a textured box of any size (smallest size is borderSize * 2 square) based on a fixed size textured box
     * with continuous borders
